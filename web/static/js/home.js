...
function draw(jsonObj) {
    ...
    /*
    nodes = [{id: 1,  shape: 'circularImage', image: DIR + 'bluehouse.jpg', label:"청와대"},{id: 2,  shape: 'circularImage', image: DIR + 'sunsiri.jpg', label:"최순실"},{id: 3,  shape: 'circularImage', image: DIR + 'geunhye.jpg', brokenImage: DIR + 'missingBrokenImage.png', label:"박근혜"},
    ];
     */
